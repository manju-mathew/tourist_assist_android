...
public final class LivePreviewActivity extends AppCompatActivity
    ...
    private static final String CAR_DETECTION = "Car Parking Sign";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> dataAdapter =
                new ArrayAdapter<>(this, R.layout.spinner_style, options);
    ...
    private void createCameraSource(String model) {
        ...
        try {
            ...
            case CLASSIFICATION:
                ...
                cameraSource
                        .setMachineLearningFrameProcessor(new CustomImageClassifierProcessor(this));
                break;
            case TEXT_DETECTION:
